let { encryptPassword, matchPassword } = require("../helper/authHelper.js")
let usersModel = require("../modal/usersModal.js")
...
let loginController = async (req, res) => {
    try {
        ...
        // create a token.
        let SECRET_KEY="helloIamvishalMaheshwariIamfromUP"
...
let restPasswordHandler = async (req, res) => {
...
module.exports = { registerController, loginController, restPasswordHandler }